package com.jihfan.books.services;
...
public class BookService {
    ...
    public Book findBookByIndex(int index) {
        if (index < books.size()){				//	Conditional to keep URL retrieval within bounds. Linked with Controllers.
    ...
    public void updateBook(int id, Book book) {			//Corresponds to Controllers updateBook method
        if (id < books.size()){
            books.set(id, book);
        }
    }
